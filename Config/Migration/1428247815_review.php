	...
	public $migration = array(
		'up' => array(
			...
			'create_field' => array(
				...
				'bbs_posts' => array(
					...
					'published_comment_counts' => array('type' => 'integer', 'null' => false, 'default' => '0', 'comment' => 'Published comment counts | 公開されたコメント数 | | ', 'after' => 'root_id'),
					'post_no' => array('type' => 'integer', 'null' => false, 'default' => '1', 'comment' => 'comment index | コメントへの採番 | | ', 'after' => 'rght'),
				),
				'bbs_posts_users' => array(
					'bbs_post_id' => array('type' => 'integer', 'null' => true, 'default' => null, 'comment' => 'Post ID | 記事ID | bbs_posts.id | ', 'after' => 'id'),
				),
			),
			'drop_field' => array(
				...
				'bbs_posts_users' => array('post_id', 'likes_flag', 'unlikes_flag'),
		...
		'down' => array(
			...
			'drop_field' => array(
				...
				'bbs_posts' => array('last_status', 'root_id', 'published_comment_counts', 'post_no'),
				'bbs_posts_users' => array('bbs_post_id'),
			),
			'create_field' => array(
				'bbs_frame_settings' => array(
